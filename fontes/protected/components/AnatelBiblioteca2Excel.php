...
class AnatelBiblioteca2Excel  {
    ...
    public static function generate($model) {
        ...
        $date = date('d_m_Y');
        $fileName = dirname(__FILE__) . '/../../assets/report' . AnatelBiblioteca2Excel::extensao;
        $uri = Yii::app()->baseUrl . '/fileDownload.php?file=report' . AnatelBiblioteca2Excel::extensao;
        ...
        $queuesIds = array(35,36,37,38,120,121,122,123);
        $servicosIds = array(252,254,255,256,257,258,262,266,272,276,280,292,322,327,331,333,342,343,344,345,1389,1390,1391,1392,1411);
        $rsl = $model->rptREPORTBiblioteca();
        $i = 9;
        ...
        // END
        $xls->setActiveSheetIndex(0);
        $xlsWriter = PHPExcel_IOFactory::createWriter($xls, AnatelBiblioteca2Excel::versaoExcel);
