...
class IncraExcelChamados  {
    ...
    public static function generate($model) {
        $fileName = dirname(__FILE__) . '/../../assets/report' . IncraExcelChamados::extensao;
        $uri = Yii::app()->baseUrl . '/fileDownload.php?file=report' . IncraExcelChamados::extensao;
        ...
        $xls->getActiveSheet()->setTitle('Incra');
