...
$dashPainels2 = $model->dashGeralCS();
$dashPainels3 = $model->dashGeralSP();
$dashPainels4 = $model->dashOutros();//CVM
$cmbAgents = $model->dashEstatAgentes();
    ...
    <div class="col-lg-3 col-sm-6">
        <section class="panel">
            ...
            <div class="value">
                ...
                ?>
                <h1 class=" count2 popovers" data-original-title="Chamados Abertos" data-content="Quantidade de chamados abertos no período: <?php echo $dashPainels2[0]['dash02_qtd_aberto'] . ".<br /><b>" . $perc1;?>%</b> dos chamados são abertos no 1º Nível." data-placement="top" data-trigger="hover" data-html="true"><?php echo $dashPainels2[0]['dash02_qtd_aberto'];?></h1>
                <h1 class=" count2 popovers" data-original-title="Chamados Fechados" data-content="Quantidade de chamados encerrados no período: <?php echo $dashPainels2[0]['dash02_qtd_fechado'] . ".<br /><b>" . $perc2;?>%</b> dos chamados são fechados no 1º Nível." data-placement="top" data-trigger="hover" data-html="true"><?php echo $dashPainels2[0]['dash02_qtd_fechado'];?></h1>
    ...
    <div class="col-lg-3 col-sm-6">
        <section class="panel">
            ...
            <div class="value">
                ...
                ?>
                <h1 class=" count3 popovers" data-original-title="Chamados Abertos" data-content="Quantidade de chamados abertos no período: <?php echo $dashPainels3[0]['dash03_qtd_aberto'] . ".<br /><b>" . $perc1;?>%</b> dos chamados são abertos no 2º Nível." data-placement="top" data-trigger="hover" data-html="true"><?php echo $dashPainels3[0]['dash03_qtd_aberto'];?></h1>
                <h1 class=" count3 popovers" data-original-title="Chamados Fechados" data-content="Quantidade de chamados encerrados no período: <?php echo $dashPainels3[0]['dash03_qtd_fechado'] . ".<br /><b>" . $perc2;?>%</b> dos chamados são fechados no 2º Nível." data-placement="top" data-trigger="hover" data-html="true"><?php echo $dashPainels3[0]['dash03_qtd_fechado'];?></h1>
    ...
    <div class="col-lg-3 col-sm-6">
        <section class="panel">
            ...
            <div class="value">
                ...
                ?>
                <!-- <h1 class=" count4 popovers" data-original-title="Chamados Abertos" data-content="Quantidade de chamados abertos no período: <?php //echo $dashPainels4[0]['dash04_qtd_aberto'] . ".<br /><b>" . $perc1;?>%</b> dos chamados são abertos no 3º Nível." data-placement="top" data-trigger="hover" data-html="true"><?php //echo $dashPainels4[0]['dash04_qtd_aberto'];?></h1>-->
                <h1 align="center" class=" count4 popovers" data-original-title="Chamados Fechados" data-content="Quantidade de chamados encerrados no período: <?php echo $dashPainels4[0]['dash04_qtd_fechado'] . ".<br /><b>" . $perc1;?>%</b> dos chamados são fechados em outras filas." data-placement="top" data-trigger="hover" data-html="true"><?php echo $dashPainels4[0]['dash04_qtd_fechado'];?></h1>
                <p>Outras Filas</p>
            </div>
        </section>
    </div>
                    ...
                    foreach ($lst as $value) {
                        ...
                        if ($value['question_id'] != 10) {
                            ...
                            foreach ($answers as $item) {
                                ...
                                $perc2 = ($item['amount'] == 0 ? 0 : round($item['amount'] * 100 / $total, 2));
