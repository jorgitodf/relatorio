...
$cs->registerScript("jsCommon",
    ...
    "  $('#DashboardAnatel_userId').val(this.value); " .
    "  $('#filtro-form').submit(); " .
    "});");
?>
        ...
        <section class="panel">
            <div class="panel-body progress-panel">
                <div class="task-progress">
                    ...
                    <p>Central de Serviços | 2º Nível - Suporte | 3º Nível - Produção</p>
                </div>
